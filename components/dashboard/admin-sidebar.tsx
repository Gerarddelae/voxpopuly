...
const menuItems = [
  ...
  },
  {
    title: "Voting Points",
    icon: MapPin,
    href: "/dashboard/admin/voting-points",
  },
  {
    title: "Users",
    icon: Users,
    ...
    <Sidebar collapsible="offcanvas" className="lg:border-r-0!" {...props}>
      <SidebarHeader className="p-3 sm:p-4 lg:p-5 pb-0">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-base sm:text-lg">VoxPopuly Admin</span>
        </div>
      </SidebarHeader>
            ...
            <div className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 rounded-lg cursor-pointer hover:bg-accent transition-colors mt-2">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-semibold text-xs sm:text-sm">
                  {authUser?.user_metadata?.full_name || authUser?.email?.split("@")?.[0] || "Admin"}
                </p>
