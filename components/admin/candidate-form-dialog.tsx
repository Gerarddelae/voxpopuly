...
import type { CandidateFormData } from '@/lib/types/database.types';
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
export function CandidateFormDialog({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(`/api/voting-points/${votingPointId}/candidates`, {
        method: 'POST',
      ...
      <DialogContent className="sm:max-w-[500px]">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>
              Agrega un candidato al tarjetón de este punto de votación
            </DialogDescription>
          </DialogHeader>
