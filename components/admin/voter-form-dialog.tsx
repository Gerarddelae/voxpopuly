...
export function VoterFormDialog({ open, onOpenChange, onSuccess, votingPointId }: VoterFormDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError('Error al crear votante');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle>
            {credentials ? 'Votante Creado Exitosamente' : 'Registrar Nuevo Votante'}
          </DialogTitle>
          <DialogDescription>
            {credentials
            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  placeholder="Ej: votante@ejemplo.com"
                  required
                  disabled={loading}
                />
              </div>
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-3">
              ...
              <Alert>
                <AlertCircle className="h-4 w-4" />
                <AlertDescription>
                  <strong>Importante:</strong> Comparta estas credenciales de forma segura con el votante.
